...
namespace EmployeeManagement.Controllers
{
    ...
    //     [Authorize(Roles="Admin, ReportsRole, ABC_Role")] 
    //      Multiple Users 

    //     [Authorize(Roles="Admin Users")] 
    //     [Authorize(Roles="Reports Users ")] 
    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                {
                    ViewBag.ErrorTitle = $"Currently {role.Name} role is in Use";
                    ViewBag.ErrorMessage = $"Currently {role.Name} role cannot be deleted as there are users " +
                        $"in this role. If you want to delete this role, please remove users from " +
                        $"the role and try to delete. ";
